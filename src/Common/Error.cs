...
public abstract class Error(int errorCode, string message, Position startPosition){
    public bool IsError => this is not ErrorNull;
    protected Position StartPosition => startPosition;
...
public abstract class RunTimeError(Position startPosition, string details, Context? context, int errorIndex)
    : Error(errorIndex, details, startPosition){
