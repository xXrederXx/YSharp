...
- ### Boolean
  Booleans can have the value true or false. They can be compared against each other if the are (not) equal. They also support some other operations such as AND, OR and NOT
